...
func TestMultipleNodes(t *testing.T) {
	...
	for i := 0; i < nodeCount; i++ {
		dataDir, err := os.MkdirTemp("", "distibuted-log-test")
		...
		// The book originally used 50 instead of 150 but I kept getting errors
		// because the leader couldn't be contacted within the duration.  The
		// cutoff was between 75ms and 80ms.  This is a test, what's an extra 75ms
		// amongst friends?
